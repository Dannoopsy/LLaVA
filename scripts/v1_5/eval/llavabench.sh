...
python3.11 -m llava.eval.model_vqa \
...
python3.11 llava/eval/eval_gpt_review_bench.py \
...
python3.11 llava/eval/summarize_gpt_review.py -f playground/data/eval/llava-bench-in-the-wild/reviews/llava-v1.5-13b.jsonl
